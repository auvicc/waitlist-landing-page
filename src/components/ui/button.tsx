...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brand-dark text-white hover:bg-brand-dark/90 hover:-translate-y-0.5 shadow-sm hover:shadow-md",
        outline:
          "border border-brand-border bg-transparent text-brand-dark hover:bg-brand-light hover:-translate-y-0.5",
        ghost:
          "text-brand-dark hover:bg-brand-light",
        link: "text-brand-dark underline-offset-4 hover:underline",
        green:
          "bg-brand-green text-white hover:bg-brand-green/90 hover:-translate-y-0.5 shadow-sm hover:shadow-md",
      },
      size: {
